...
export default function LoggedInProfile() {
  ...
  // Using a cleaner abstract cover image
  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-12">
      ...
      {/* Increased negative margin to pull card up nicely */}
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-slate-100 overflow-visible">
          ...
          <div className="p-6 md:p-10 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 bg-slate-50/30">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm flex items-center gap-4 hover:border-blue-100 transition-colors">
              ...
              <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm flex items-center gap-4 hover:border-purple-100 transition-colors">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white border border-slate-100 rounded-2xl p-6 relative overflow-hidden h-full shadow-sm hover:border-red-100 transition-colors group">
