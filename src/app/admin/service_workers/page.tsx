...
export default function UsersList() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-2 sm:p-4 lg:ml-64 -mt-2 sm:-mt-4">
      ...
      {/* Loading State */}
      {loading ? (
        <div className="flex items-center justify-center min-h-[60vh] sm:min-h-[50vh]">
          <div className="text-gray-500 text-sm sm:text-base">Loading users...</div>
        </div>
      ) : (
        /* Main Content - Full height responsive container */
        <div className="h-[calc(100vh-120px)] sm:h-[calc(100vh-140px)] lg:h-auto flex flex-col">
          {/* Desktop Table - Hidden on mobile */}
          <div className="hidden sm:block flex-1 overflow-hidden">
            <div className="overflow-x-auto shadow-sm rounded-lg h-full">
