...
import Wrench from '../animation/Wrench'
...
<Wrench />
       ...
       <Link href='/publicpages/client/findworker' className="bg-white text-blue-600 hover:bg-gray-100 px-5 py-2 rounded-md font-medium">  Find a Professional</Link>  
